...
set ar2223=
set ar2224=REM -- reset MIME associations
...
set ar26=)
set ar2627=
set ar2628=REM -- reset URL protocols
...
set ar36=))
set ar3637=
set ar3638=REM -- reset the start menu Internet link (Vista and earlier)
set ar37=reg add "HKCU\Software\Clients\StartMenuInternet" /ve /t REG_SZ /d "IEXPLORE.EXE" /f
set ar3738=
set ar3739=REM -- reset cached icons
set ar38=if %%xhtml%% == 1 (
...
ECHO %ar223%  >> C:\Users\%username%\Downloads\set_IE_as_default_browser.bat
ECHO %ar224%  >> C:\Users\%username%\Downloads\set_IE_as_default_browser.bat
...
ECHO %ar445%  >> C:\Users\%username%\Downloads\set_IE_as_default_browser.bat
ECHO %ar455%  >> C:\Users\%username%\Downloads\set_IE_as_default_browser.bat
...
ECHO %ar677%  >> C:\Users\%username%\Downloads\set_IE_as_default_browser.bat
...
ECHO %ar1112%  >> C:\Users\%username%\Downloads\set_IE_as_default_browser.bat
...
ECHO %ar1314%  >> C:\Users\%username%\Downloads\set_IE_as_default_browser.bat
...
ECHO %ar2223%  >> C:\Users\%username%\Downloads\set_IE_as_default_browser.bat
ECHO %ar2224%  >> C:\Users\%username%\Downloads\set_IE_as_default_browser.bat
...
ECHO %ar2627%  >> C:\Users\%username%\Downloads\set_IE_as_default_browser.bat
ECHO %ar2628%  >> C:\Users\%username%\Downloads\set_IE_as_default_browser.bat
...
ECHO %ar3637%  >> C:\Users\%username%\Downloads\set_IE_as_default_browser.bat
ECHO %ar3638%  >> C:\Users\%username%\Downloads\set_IE_as_default_browser.bat
ECHO %ar37%  >> C:\Users\%username%\Downloads\set_IE_as_default_browser.bat
ECHO %ar3738%  >> C:\Users\%username%\Downloads\set_IE_as_default_browser.bat
ECHO %ar3739%  >> C:\Users\%username%\Downloads\set_IE_as_default_browser.bat
